...
export class HomeComponent implements AfterViewInit {
    ...
    private room_list = [
        ...
        { name: "Cabine F", cabin_status: "En Cours", ico_status: "sync", seller_name: "Seller : Sophia Mason", alert_msg: false },
    ...
    //room detail
    private clientName_ = "Nelly Maccario";
    ...
    ngAfterViewInit() {
        ...
        $("#doSomeThing_btn").on('click', (e, args) => {
            ...
            this.roomSelected_list.push({ name: this.room_list[this.room_index].name, cabin_status: "En Cours", ico_status: "sync", seller_name: "Seller : Olivia Stone", alert_msg: false });
