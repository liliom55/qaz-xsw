import { FrontSide, RepeatWrapping, Color, MeshPhongMaterial, Vector2, TextureLoader, DefaultLoadingManager, Loader, FileLoader } from 'three';
/**
...
class MTLLoader {
	...
	parse ( text ) {
		...
		var materialCreator: MaterialCreator = new MaterialCreator( this.texturePath || this.path, this.materialOptions );
...
class MaterialCreator {
	...
	loadTexture ( url, mapping?, onLoad?, onProgress?, onError? ) {
		...
		var texture;
		var loader: any = Loader.Handlers.get( url );
