import { FrontSide, RepeatWrapping, Color, Vector2, TextureLoader, DefaultLoadingManager, Loader, FileLoader, 
    LineSegments, Mesh, SmoothShading, FlatShading, BufferGeometry, BufferAttribute, LineBasicMaterial, MeshPhongMaterial, Material, Group } from 'three';
...
class OBJLoader {
	...
	parse ( text ) {
		...
		var state: any = this._createParserState();
