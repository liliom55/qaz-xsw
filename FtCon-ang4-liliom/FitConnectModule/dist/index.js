import { Component, EventEmitter, Injectable, NgModule, ViewChild, ViewEncapsulation } from '@angular/core';
import { CommonModule } from '@angular/common';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { MaterialModule, MdDialog, MdDialogRef, MdIconRegistry } from '@angular/material';
...
import { TranslateLoader, TranslateModule, TranslateService, TranslateStaticLoader } from 'ng2-translate/index';
import 'rxjs/Rx';
...
var DataService = (function () {
    ...
    DataService.prototype.addCapture = function (measurements) {
        ...
        var /** @type {?} */ headers = new Headers({ 'Authorization': environment.API_AUTH });
...
var FitMediatorComponent = (function () {
    ...
    FitMediatorComponent.propDecorators = {
        'mediatorSidenav': [{ type: ViewChild, args: ['mediatorSidenav',] },],
    };
...
var FitDialogComponent = (function () {
    ...
    FitDialogComponent.prototype.getInImperial = function (value, unit) {
        ...
        var /** @type {?} */ conformedValue = conformToMask(valueNotFormatted, mask, { guide: false });
...
export { createTranslateLoader, FitConnectModule, FitMediatorComponent, FitDialogComponent, MetaformaService };
